        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf">
                    <strong class="am-text-primary am-text-lg">添加数据模板</strong> /
                    <small>Add DataTemplate</small>
                </div>
            </div>
            <hr/>
                ...
                <div class="am-tabs-bd">
                    <form class="am-form" action="${pageContext.request.contextPath}/DataManage/doAddOrUpdateDataTemplate" method="post">
                        <div class="am-g am-margin-top">
                            <div class="am-u-sm-4 am-u-md-4 am-text-right">模板名:</div>
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <input type="text" name="sTemplateName"  class="am-input-sm" placeholder="请输入模板名" required>
                            </div>
                        </div>
