        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf">
                    <strong class="am-text-primary am-text-lg">编辑数据点</strong> /
                    <small>Edit DataPoint</small>
                </div>
            </div>
                    ...
                    <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/DataManage/doAddOrUpdateDataPoint" method="post">
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                ...
                                <input type="text" name="sName" id="sName" value="${dataPoint.sName}" placeholder="名称" required>
                                <small>输入你的数据点名称。</small>
                            </div>
                        </div>
                        <script>
                            $(function () {
                                var editDataPointMessage = "${requestScope.editDataPointMessage}";
                                if (!$.isEmptyObject(editDataPointMessage)) {
                                    alert(editDataPointMessage);
                                    history.back();
                                }
                                //默认数据模板 数值类型 小数位数 select
                                $("select[name='iDataTemplateId']").val(${dataPoint.dataTemplate.id});
                                $("select[name='iValueKind']").val(${dataPoint.iValueKind});
                                $("select[name='iDecimalAccuracy']").val(${dataPoint.iDecimalAccuracy});
                                //默认选择 数据类型 读写 存储方式  radio
                                $("input:radio[name='iType'][value='${dataPoint.iType}']").attr("checked",'checked');
                                $("input:radio[name='iWriteRead'][value='${dataPoint.iWriteRead}']").attr("checked",'checked');
                                $("input:radio[name='iStorage'][value='${dataPoint.iStorage}']").attr("checked",'checked');
                            });
                        </script>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="sRegister" id="sRegister" value="${dataPoint.sRegister}" placeholder="功能码03H或06H，起始地址0000H，则填：40001；" required>
                        ...
                        <div class="am-form-group" id="iLengthGroup">
                            ...
                            <div  class="am-u-sm-9">
                                <input type="number" name="iLength" min="0" max="100" value="${dataPoint.iLength}">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group" id="sUnitGroup">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="sUnit" id="sUnit" value="${dataPoint.sUnit}" >
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="sDescription" id="sDescription" value="${dataPoint.sDescription}" >
                            </div>
                        </div>
                        ...
                        <div class="am-form-group" id="sFormulaGroup">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="sFormula" id="sFormula" value="${dataPoint.sFormula}" >
                            </div>
                        </div>
                        ...
                        <div class="am-form-group" id="sReverseFormulaGroup">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="sReverseFormula" id="sReverseFormula" placeholder="" >
                            </div>
                        </div>
