                ...
                <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                    <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/Alarm/doAddOrUpdateContact" method="post">
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-6">
                                <input type="text" name="sName" id="sName" placeholder="姓名..." required>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-6">
                                <input type="text" name="sPhone" id="sPhone" placeholder="手机..." required>
                            </div>
                            <div class="am-u-sm-3"></div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-6">
                                <input type="text" name="sEmail" id="sEmail" placeholder="邮箱..." required>
                            </div>
                            <div class="am-u-sm-3"></div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-6">
                                <input type="text" name="sWeChat" id="sWeChat" placeholder="微信...">
                            </div>
                            <div class="am-u-sm-3"></div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-6">
                                <textarea rows="5" name="sNote" id="sNote" placeholder="备注..." ></textarea>
                            </div>
                            <div class="am-u-sm-3"></div>
                        </div>
