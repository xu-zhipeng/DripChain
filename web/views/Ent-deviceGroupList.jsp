        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf">
                    <strong class="am-text-primary am-text-lg">设备分组列表</strong> /
                    <small>DeviceGroup List</small>
                </div>
            </div>
            <script>
                $(function () {
                    var DeviceGroupMessage = "${param.DeviceGroupMessage}";
                    if (!$.isEmptyObject(DeviceGroupMessage)) {
                        alert(DeviceGroupMessage);
                        history.back();
                    }
                    var delDeviceGroupMessage = "${param.delDeviceGroupMessage}";
                    if (!$.isEmptyObject(delDeviceGroupMessage)) {
                        alert(delDeviceGroupMessage);
                    }
                });
            </script>
            ...
            <div class="am-g">
                <div class="am-u-sm-12">
                    ...
                    <a href="${pageContext.request.contextPath}/Device/addDeviceGroup" type="button"
                            ...
                            <li>
                                ...
                                <div class="am-topbar-right">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a href="${pageContext.request.contextPath}/Device/editDeviceGroup/${li.id}" class="am-btn am-btn-default am-btn-xs am-text-secondary"
                                                data-am-modal="{target: '#my-alert'}"><span
                                                class="am-icon-pencil-square-o"></span>编辑
                                        </a>
                                        <a   href="${pageContext.request.contextPath}/Device/delDeviceGroup/${li.id}"
