        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf">
                    <strong class="am-text-primary am-text-lg">编辑数据模板</strong> /
                    <small>Edit DataTemplate</small>
                </div>
            </div>
            <hr/>
            <script>
                $(function () {
                    var editDataTemplateMessage = "${requestScope.editDataTemplateMessage}";
                    if (!$.isEmptyObject(editDataTemplateMessage)) {
                        alert(editDataTemplateMessage);
                        history.back();
                    }
                });
            </script>
            <div class="am-tabs data-am-tabs">
                <div class="am-tabs-bd">
                    <form class="am-form" action="${pageContext.request.contextPath}/DataManage/doAddOrUpdateDataTemplate" method="post">
                        <div class="am-g am-margin-top">
                            <div class="am-u-sm-4 am-u-md-4 am-text-right">分组名:</div>
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <input type="hidden" name="id" value="${dataTemplate.id}">
                                <input type="text" name="sTemplateName" value="${dataTemplate.sTemplateName}" class="am-input-sm" placeholder="请输入设备分组名" required>
                            </div>
                        </div>
