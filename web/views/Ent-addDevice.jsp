        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf">
                    <strong class="am-text-primary am-text-lg">添加设备</strong> /
                    <small>添加设备</small>
                </div>
            </div>
            <hr/>
            <div class="am-g">
                ...
                <script>
                    ...
                    var sDeviceNameGroup = '<div class="am-form-group" id="sDeviceNameGroup">\n' +
                        ...
                        '                            </label>\n' +
                        '                            <div class="am-u-sm-9">\n' +
                        '                                <input type="text" id="sDeviceName" name="sDeviceName" placeholder="设备名称" required>\n' +
                    ...
                    var sDeviceIdGroupAuto = '<div class="am-form-group" id="sDeviceIdGroupAuto">\n' +
                        ...
                        '                            </label>\n' +
                        '                            <div class="am-u-sm-9">\n' +
                        '                                <input type="text" id="sDeviceId" name="sDeviceId" placeholder="设备ID 自动生成" readonly>\n' +
                        '                            </div>\n' +
                        '                        </div>';
                    var sDeviceIdGroup = '<div class="am-form-group" id="sDeviceIdGroup">\n' +
                        ...
                        '                            </label>\n' +
                        '                            <div class="am-u-sm-9">\n' +
                        '                                <input type="text" id="sDeviceId" name="sDeviceId" required>\n' +
                        '                            </div>\n' +
                        '                        </div>';
                    ...
                    $(function () {
                        ...
                        innitForm(0);
                        //默认选中
                        $("input:radio[name='iDeviceType'][value='0']").attr("checked", 'checked');
                ...
                <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                    <form id="DeviceForm" class="am-form am-form-horizontal"
                          action="${pageContext.request.contextPath}/Device/doAddDevice" method="post"
                                ...
                                <div class="am-u-sm-9">
                                    <div class="am-scrollable-horizontal">
                                        <table id="deviceSlaveTable"
                                            ...
                                            <tbody>
                                            <tr class="am-success">
                                                <td><input type="text" name="sSlaveIndex" value="1" required/></td>
                                                <td><input type="text" name="sSlaveName" value="电导率" required/></td>
                                                <td><input type="text" name="sSlaveAddr" value="01" required/></td>
                                                <td>
                                                    <select name="iDataTemplateId" required>
                                                        <option value="">请选择</option>
                                                        <c:forEach items="${DataTemplateList}" var="i">
                                            ...
                                            <tr class="am-success">
                                                <td><input type="text" name="sSlaveIndex" value="2" required/></td>
                                                <td><input type="text" name="sSlaveName" value="流量计" required/></td>
                                                <td><input type="text" name="sSlaveAddr" value="08" required/></td>
                                                <td>
                                                    <select name="iDataTemplateId" required>
                                                        <option value="">请选择</option>
                                                        <c:forEach items="${DataTemplateList}" var="i">
                        ...
                        <div class="am-form-group" id="DeviceMap">
                            ...
                            <div class="am-u-sm-9">
                                ...
                                <div id="r-result">
                                    ...
                                    <div>
                                        地址:<br>
                                        <input id="sDeviceAddress" name="sDeviceAddress" type="text" style="width: 80%;display: inline-block;" required/>
                                        <button type="button" id="btn" class="am-btn am-btn-primary" >定位</button><br>
                                        经度:
                                        <input id="dDeviceLongitude" name="dDeviceLongitude" type="text" required/>
                                        纬度:
                                        <input id="dDeviceLatitude" name="dDeviceLatitude" type="text" required/>
                                    </div>
                                </div>
                                <!--结束-->
                            </div>
