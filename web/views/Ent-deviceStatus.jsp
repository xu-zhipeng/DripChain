        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf">
                    <strong class="am-text-primary am-text-lg">设备状态</strong> /
                    <small>设备状态</small>
                </div>
            </div>
            <hr/>
                        ...
                        <table class="am-table am-table-striped am-table-hover table-main">
                            <tr>
                                <div class="am-g">
                                    ...
                                    <div class="am-u-lg-6">
                                        <form action="${pageContext.request.contextPath}/Device/deviceStatusList" method="get">
                            ...
                            <tr>
                                ...
                                <th class="table-title ">设备状态</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${pageBean.list}" var="li">
                            <tr>
                                <td class="am-hide-sm-only">${li.sDeviceName}</td>
                                <td class="am-hide-sm-only">${li.sDeviceId}</td>
                                <c:if test="${li.iDeviceStatus==0}">
                                    <td class="am-hide-sm-only" style="color: red;">离线</td>
                                </c:if>
                                <c:if test="${li.iDeviceStatus==1}">
                                    <td class="am-hide-sm-only" style="color: green;">在线</td>
                                </c:if>
                            </tr>
                            </c:forEach>
                            </tbody>
                                ...
                                <ul class="am-pagination am-pagination-centered">
                                    ...
                                    <c:choose>
                                        <c:when test="${pageBean.pageNum > 1}">
                                            <li>
                                                <a href="${pageContext.request.contextPath}/Device/deviceStatusList/${pageBean.pageNum-1}">«</a>
                                            </li>
                                        </c:when>
                                        <c:otherwise>
                                    ...
                                    <c:forEach begin="${pageBean.start}" end="${pageBean.end}" step="1" var="i">
                                        ...
                                        <c:if test="${pageBean.pageNum != i}">
                                            <li>
                                                <a href="${pageContext.request.contextPath}/Device/deviceStatusList/${i}">${i}</a>
                                            </li>
                                        </c:if>
                                    </c:forEach>
                                    <c:choose>
