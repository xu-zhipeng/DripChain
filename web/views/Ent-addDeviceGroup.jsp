        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf">
                    <strong class="am-text-primary am-text-lg">添加设备分组</strong> /
                    <small>Add DeviceGroup</small>
                </div>
            </div>
            <hr/>
                    ...
                    <form class="am-form" action="${pageContext.request.contextPath}/Device/doAddOrUpdateDeviceGroup" method="post">
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <input type="text" name="sGroupName"  class="am-input-sm" placeholder="请输入设备分组名" required>
                            </div>
                        </div>
